...
module.exports = {
     ...
     */
    botname: process.env.BotName || "〆 𝐍𝐎𝐁𝐈𝐓𝐀 𓆩愛𓆪",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 〆 𝐍𝐎𝐁𝐈𝐓𝐀 𓆩愛𓆪",
     ...
     */
    ownername: process.env.Owner_Name || "⏤͟͟͞➣⃟⃟🍒𝚫𝐘𝚫𝚭~ ⃟⃟⃟⃟❤️",
    ownernumber: process.env.Owner_Number || "923112345043",
    instagramId: process.env.Insta || "ayazaliofc",

    /**
     * other details and parameters
     */
    author: process.env.Author || "ɳoɓꀤʈɑ 👑🖤🎧",
    packname: process.env.PackName || "Made By",
    socialLink: process.env.Web || "https://wa.me/923112345043",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/HIcgfURfAZiKS8AOWCSu4z",
